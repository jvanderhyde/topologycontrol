...
void octree::getRange(int level,int downToLevel,int startx,int starty,int startz,int lenx,int leny,int lenz,
		      octree** result,octree** space,int deepest)
{
  if (level>downToLevel)
      ...
      if (children != NULL)
	{
	  ...
	  if (children[c] != NULL)
	    {
	      //recurse to child
	      children[c]->getRange(level-1,downToLevel,startx,starty,startz,lenx1,leny1,lenz1,result+num,space+num,deepest);
	      //reorder
	  ...
	  if (lenx2>0)
	    {
	      ...
	      if (children[c] != NULL)
		{
		  children[c]->getRange(level-1,downToLevel,startx2,starty,startz,lenx2,leny1,lenz1,result+num,space+num,deepest);
	  ...
	  if (leny2>0)
	    {
	      ...
	      if (children[c] != NULL)
		{
		  children[c]->getRange(level-1,downToLevel,startx,starty2,startz,lenx1,leny2,lenz1,result+num,space+num,deepest);
	  ...
	  if (lenz2>0)
	    {
	      ...
	      if (children[c] != NULL)
		{
		  children[c]->getRange(level-1,downToLevel,startx,starty,startz2,lenx1,leny1,lenz2,result+num,space+num,deepest);
	  ...
	  if ((lenx2>0) && (leny2>0))
	    {
	      ...
	      if (children[c] != NULL)
		{
		  children[c]->getRange(level-1,downToLevel,startx2,starty2,startz,lenx2,leny2,lenz1,result+num,space+num,deepest);
	  ...
	  if ((leny2>0) && (lenz2>0))
	    {
	      ...
	      if (children[c] != NULL)
		{
		  children[c]->getRange(level-1,downToLevel,startx,starty2,startz2,lenx1,leny2,lenz2,result+num,space+num,deepest);
	  ...
	  if ((lenz2>0) && (lenx2>0))
	    {
	      ...
	      if (children[c] != NULL)
		{
		  children[c]->getRange(level-1,downToLevel,startx2,starty,startz2,lenx2,leny1,lenz2,result+num,space+num,deepest);
	  ...
	  if ((lenx2>0) && (leny2>0) && (lenz2>0))
	    {
	      ...
	      if (children[c] != NULL)
		{
		  children[c]->getRange(level-1,downToLevel,startx2,starty2,startz2,lenx2,leny2,lenz2,result+num,space+num,deepest);
