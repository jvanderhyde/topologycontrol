...
void volume::carveInside(int numFeaturesToOpen)
{
	...
	pqitem startvoxel(-1,size[0]/2,size[1]/2,size[2]/5);
...
void volume::carveSimultaneously(int numFeaturesToOpen)
{
	...
	//carve minimum voxel to start inner boundary
	//pqitem startvoxel(-1,192,140,200);
	//pqitem startvoxel(-1,330,195,96);
	pqitem startvoxel(-1,156,118,52); //dragon70.vri
...
// Each bit in the first set indicates the voxel is positive.
