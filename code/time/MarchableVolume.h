...
class MarchableVolume4D : public MarchableVolume
{
 protected:
  int currentTimeSlice,numTimeSlices;
  int numVoxelsInTimeSlice,numTotalVoxels;
  
 public:
  MarchableVolume4D();
  ~MarchableVolume4D();
  void setCurrentTimeSlice(int s);
};

class FloatVolume4D : public MarchableVolume4D
{
 protected:
  float* data;
  void copySlice(int z,float* slice);
...
class ByteVolume4D : public MarchableVolume4D
{
 protected:
  unsigned char* data;
  void copySlice(int z,float* slice);
