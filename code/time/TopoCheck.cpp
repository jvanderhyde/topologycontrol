...
TopoCheckThick2D3DDouble::TopoCheckThick2D3DDouble() : TopoCheck()
{
}

int TopoCheckThick2D3DDouble::topologyChange(int neighborhood)
{
    int nbhd1=0x0,nbhd2=0x1ff;
    nbhd1|=neighborhood<<9;
    nbhd2|=neighborhood<<9;
    return topo3D.topologyChange(nbhd1) || topo3D.topologyChange(nbhd2);
}

int TopoCheckThick2D3DDouble::getDimension()
{
    return 3;
}
